...
-(void)sendComment:(czzComment *)comment toVideo:(NSInteger)videoID{
    ...
    if (currentLoginUser){
        [request setValue:currentLoginUser.access_token forHTTPHeaderField:@"Authorization"];
    } else {
    ...
    NSString *contentData = [NSString stringWithFormat:@"content=%@&quoteId=103", comment.content];
